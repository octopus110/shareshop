...
<div class="pageContent">
    <div class="pageFormContent" layoutH="10">
        ...
        <form method="post" action="commodity/add" class="pageForm required-validate"
            ...
            <p>
                ...
                @else
                    <input name="" type="text" class="required readonly" value="{{ $merchant->storename }}"/>
            ...
            <p>
                <label>库存数量：</label>
                <input name="quantity" type="text" class="required" alt="输入数量"/>
            </p>

            <p>
                <label>商品价格：</label>
                <input name="price" type="text" class="required" alt="输入价格"/>
            </p>
