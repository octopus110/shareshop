    ...
    <form method="post" action="/server/banner/update" enctype="multipart/form-data"
        ...
        <div class="pageFormContent" layoutH="56">
            <div class="unit">
                ...
                <div style="padding-bottom: 10px;">*如果要替换，删除后上传即可</div>

                <div class="upload-wrap">
                    <input type="file" name="image[]" accept="image/*" class="valid" style="left: 0px;">
                    @if(isset($images[0]))
                        <div class="thumbnail">
                            <img src="/uploads/{{ $images[0]['src'] }}" style="max-width: 80px; max-height: 80px">
                ...
                <div class="upload-wrap">
                    ...
                    @if(isset($images[1]))
                        <div class="thumbnail">
                            <img src="/uploads/{{ $images[1]['src'] }}" style="max-width: 80px; max-height: 80px">
                ...
                <div class="upload-wrap">
                    ...
                    @if(isset($images[2]))
                        <div class="thumbnail">
                            <img src="/uploads/{{ $images[2]['src'] }}" style="max-width: 80px; max-height: 80px">
                ...
                <div class="upload-wrap">
                    ...
                    @if(isset($images[3]))
                        <div class="thumbnail">
                            <img src="/uploads/{{ $images[3]['src'] }}" style="max-width: 80px; max-height: 80px">
